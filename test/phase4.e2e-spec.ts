...
describe('Phase 4 : filtre dons/échanges, estimation de prix, fiche complète', () => {
  ...
  it('fiche complète : badge uniquement avec 3 photos, description longue et tous les champs de la catégorie', async () => {
    ...
    const full = await createListing(app, user, {
      ...
      categorySlug: 'voitures',
      price: 13900,
      attributes: { marque: 'Renault', modele: 'Clio', annee: 2021, kilometrage: 38000, type_vehicule: 'Citadine', carburant: 'Essence', boite: 'Manuelle', puissance_fiscale: 5, puissance_din: 100, portes: '5', places: 5, couleur: 'Gris', sellerie: 'Tissu', critair: '1', controle_technique: true, premiere_main: true },
    });
    for (let i = 0; i < 3; i++) {
