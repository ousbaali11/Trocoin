...
const KEYWORDS: Record<string, string[]> = {
  ...
  decoration: ['deco', 'decoration', 'lampe', 'lampadaire', 'miroir', 'tapis', 'rideau', 'rideaux', 'cadre', 'tableau', 'vase', 'bougie', 'coussin', 'vaisselle', 'assiettes', 'verres', 'couverts', 'plaid', 'horloge', 'luminaire', 'suspension'],
